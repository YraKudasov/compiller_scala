...
static Field*
_Json_new_field(Json* json, const char* field_name, JsonValueType value_type) {
    Field* prev_field = json->last;

    Field* new_field = (Field*)malloc(sizeof(Field));
    new_field->value_type = value_type;
    new_field->field_name = (char*)(field_name == NULL ? field_name : _strdup(field_name));
...
Json*
Json_add_string_to_object(Json* object, const char* field_name, char* value) {
...
Json*
Json_add_double_to_object(Json* object, const char* field_name, double value) {
...
Json*
Json_add_int_to_object(Json* object, const char* field_name, int value) {
...
Json*
Json_add_object_to_object(Json* object, const char* field_name, Json* object_value) {
...
Json*
Json_add_bool_to_object(Json* object, const char* field_name, bool value) {
...
Json*
Json_add_null_to_object(Json* object, const char* field_name) {
